...
trait Maker
{
    ...
    protected function get_class_name($control, $namespace = 'Condify\\Controls')
    {
    ...
    {
        if(! file_exists($this->condition_file_link)){
            $this->file_exists = false;
            return $this;
        }
        require_once $this->condition_file_link;

        $class_name = $this->get_class_name($this->config['condition_name'], 'Condify\\Conditions');
